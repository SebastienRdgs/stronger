import{d as t,m as c,q as o,t as i,I as f}from"./entry.0d31dd74.js";const p={class:"flex-1 h-[50vh]"},_=`Game 1: 12 blue; 2 green, 13 blue, 19 red; 13 red, 3 green, 14 blue
...
Game 100: 8 red, 4 blue, 4 green; 10 blue, 3 red, 4 green; 10 green, 4 red; 18 red, 9 blue, 2 green; 12 red, 4 green, 2 blue`,y=t({__name:"01122023",setup(h){const a=e=>e.split(`
`).map((l,d)=>l.split(`Game ${d+1}: `)[1].split(";").map((u,I)=>u.trim().split(",").map((b,B)=>{const s=b.trim().split(" ");return m(s)}).find(b=>b==!1)).find(u=>u==!1)).reduce((l,d,g)=>(d!==!1&&(l+=g+1),l),0),m=e=>{const r={red:12,green:13,blue:14};let n=!0;return(e[1]==="red"&&parseInt(e[0])>r.red||e[1]==="green"&&parseInt(e[0])>r.green||e[1]==="blue"&&parseInt(e[0])>r.blue)&&(n=!1),n},G=a(_);return(e,r)=>(c(),o("div",p,i(f(G)),1))}});export{y as default};
