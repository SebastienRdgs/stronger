import{d as c,m as o,q as i,t as p,I as f}from"./entry.0d31dd74.js";const _={class:"flex-1 h-[50vh]"},h=`Game 1: 12 blue; 2 green, 13 blue, 19 red; 13 red, 3 green, 14 blue
...
Game 100: 8 red, 4 blue, 4 green; 10 blue, 3 red, 4 green; 10 green, 4 red; 18 red, 9 blue, 2 green; 12 red, 4 green, 2 blue`,q=c({__name:"02122023",setup(S){const g=n=>n.split(`
`).map((u,l)=>{const G=u.split(`Game ${l+1}: `)[1].split(";").map((s,x)=>s.trim().split(",").map((t,B)=>t.trim().split(" "))),d=a(G);return d.blue*d.green*d.red}).reduce((u,l)=>u+l,0),a=n=>{const e={red:0,green:0,blue:0};for(const b of n)for(const r of b)e[r[1]]<parseInt(r[0])&&(e[r[1]]=parseInt(r[0]));return e},m=g(h);return(n,e)=>(o(),i("div",_,p(f(m)),1))}});export{q as default};
